...
URLS_BY_STATE = {
	...
	"Mississippi": {"code": "MS",
					...
					"cities": ['Hattiesburg', 'Jackson', 'Biloxi', 'Gulfport', 'Greenwood', 'Columbus']},
	"Missouri": {"code": "MO",
	...
	"South Carolina": {"code": "SC",
					   ...
					   "polls": "https://info.scvotes.sc.gov/eng/voterinquiry/VoterInformationRequest.aspx"
								"?PageMode=VoterInfo",
					   "cities": ['Charleston', 'Columbia', 'Greenville', 'Augusta', 'Springfield']},
	"South Dakota": {"code": "SD",
					 "reg": "https://vip.sdsos.gov/viplogin.aspx",
					 "polls": "https://vip.sdsos.gov/viplogin.aspx",
					 "cities": ['Sioux Falls', 'Rapid City', 'Mitchell', 'Pierre', 'Springfield']},
	"Tennessee": {"code": "TN",
