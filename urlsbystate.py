...
URLS_BY_STATE = {
	"Alabama": {"code": "AL",
				...
				"cities": ['Birmingham', 'Anniston', 'Montgomery']},
	"Alaska": {"code": "AK",
	...
	"Colorado": {"code": "CO",
				 ...
				 "cities": ['Colorado Springs', 'Denver', 'Boulder', 'Grand Junction', 'Pueblo', 'Greeley']},
	"Connecticut": {"code": "CT",
	...
	"Illinois": {"code": "IL",
				 ...
				 "cities": ['Chicago', 'Evanston', 'E. St. Louis', 'Peoria', 'Springfield', 'Rockford', 'Decatur']},
	"Indiana": {"code": "IN",
	...
	"Iowa": {"code": "IA",
			 ...
			 "cities": ['Dubuque', 'Ames', 'Cedar Rapids', 'Des Moines', 'Sioux City']},
	"Kansas": {"code": "KS",
	...
	"Louisiana": {"code": "LA",
				  ...
				  "cities": ['New Orleans', 'Shreveport', 'Baton Rouge', 'Monroe', 'Lake Charles']},
	"Maine": {"code": "ME",
	...
	"Massachusetts": {"code": "MA",
					  ...
					  "cities": ['Boston', 'Springfield', 'Newton', 'Worcester', 'New Bedford', 'Quincy']},
	"Michigan": {"code": "MI",
	...
	"Mississippi": {"code": "MS",
					...
					"cities": ['Hattiesburg', 'Jackson', 'Biloxi', 'Gulfport']},
	"Missouri": {"code": "MO",
	...
	"Montana": {"code": "MT",
				...
				"cities": ['Bozeman', 'Butte', 'Great Falls', 'Billings', 'Missoula', 'Helena']},
	"Nebraska": {"code": "NE",
				 ...
				 "cities": ['Omaha', 'Lincoln', 'North Platte']},
	"Nevada": {"code": "NV",
	...
	"New Hampshire": {"code": "NH",
					  ...
					  "cities": ['Berlin', 'Manchester', 'Nashua', 'Concord', 'Hanover', 'Portsmouth']},
	"New Jersey": {"code": "NJ",
	...
	"New Mexico": {"code": "NM",
				   ...
				   "cities": ['Gallup', 'Albuquerque', 'Santa Fe', 'Las Cruces', 'Los Alamos']},
	"New York": {"code": "NY",
				 "reg": "https://voterlookup.elections.ny.gov/",
				 "polls": "https://voterlookup.elections.ny.gov/",
				 "cities": ['New York City', 'Albany', 'Rochester', 'Buffalo', 'Binghamton', 'Syracuse']},
	"North Carolina": {"code": "NC",
					   "reg": "https://vt.ncsbe.gov/RegLkup/",
					   "polls": "https://vt.ncsbe.gov/PPLkup/",
					   "cities": ['Raleigh', 'Greensboro', 'Winston-Salem', 'Charlotte', 'Wilmington', 'Asheville']},
	...
	"South Dakota": {"code": "SD",
					 ...
					 "cities": ['Sioux Falls', 'Rapid City', 'Mitchell', 'Pierre']},
	"Tennessee": {"code": "TN",
	...
	"Texas": {"code": "TX",
			  ...
			  "cities": ['Dallas', 'Fort Worth', 'Austin', 'Houston', 'Amarillo', 'Lubbock', 'El Paso', 'San Antonio']},
	"Utah": {"code": "UT",
			 ...
			 "cities": ['Provo', 'Salt Lake City', 'Ogden', 'Cedar City']},
	"Vermont": {"code": "VT",
				"reg": "https://mvp.sec.state.vt.us/",
				"polls": "https://mvp.sec.state.vt.us/",
				"cities": ['Brattleboro', 'Rutland', 'Burlington', 'Barre', 'Montpelier']},
	"Virginia": {"code": "VA",
	...
	"West Virginia": {"code": "WV",
					  ...
					  "cities": ['Huntington', 'Charleston', 'Parkersburg', 'Wheeling', 'Clarksburg']},
	"Wisconsin": {"code": "WI",
